...
public partial class AppDbContext : DbContext
{
    ...
    public virtual DbSet<KioskActivationCode> KioskActivationCodes { get; set; }
    public virtual DbSet<KioskDevice> KioskDevices { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AttendanceRecord>(entity =>
        {
            ...
            entity.HasOne(d => d.Kiosk).WithMany(p => p.AttendanceRecords)
                .HasForeignKey(d => d.KioskId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("FK_Attendance_Kiosk");
        });
        ...
        modelBuilder.Entity<KioskDevice>(entity =>
        {
            ...
            entity.Property(e => e.KioskCode).HasMaxLength(30);
            entity.Property(e => e.Name).HasMaxLength(100);
            entity.Property(e => e.DeviceToken).HasMaxLength(128);
            entity.Property(e => e.Status).HasMaxLength(20).HasDefaultValue("Active");
            entity.Property(e => e.IpAddress).HasMaxLength(45);
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("CURRENT_TIMESTAMP(6)");

            entity.HasOne(d => d.Store).WithMany(p => p.KioskDevices)
                .HasForeignKey(d => d.StoreId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK_Kiosks_Store");
        });

        modelBuilder.Entity<KioskActivationCode>(entity =>
        {
            entity.HasKey(e => e.ActivationCodeId);

            entity.HasIndex(e => e.Code).IsUnique();
            entity.HasIndex(e => new { e.Code, e.IsUsed, e.ExpiresAt });

            entity.Property(e => e.KioskName).HasMaxLength(100);
            entity.Property(e => e.Code).HasMaxLength(20);
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("CURRENT_TIMESTAMP(6)");

            entity.HasOne(d => d.Store).WithMany(p => p.KioskActivationCodes)
                .HasForeignKey(d => d.StoreId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK_KioskCode_Store");

            entity.HasOne(d => d.GeneratedByNavigation).WithMany()
                .HasForeignKey(d => d.GeneratedBy)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("FK_KioskCode_User");

            entity.HasOne(d => d.CreatedKiosk).WithMany()
                .HasForeignKey(d => d.CreatedKioskId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("FK_KioskCode_Kiosk");
        });
