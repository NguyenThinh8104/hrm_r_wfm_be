...
public interface IUserService
{
    ...
    // UC 1.6: Cấp mã PIN Chấm công Kiosk
    Task<ApiResponse<ResetPinResponseDto>> ResetKioskPinAsync(ulong userId, ResetPinRequestDto dto, ulong actorId, string actorRole, ulong? actorBranchId, string? ipAddress);
