...
public class AttendanceService : IAttendanceService
{
    ...
    public async Task<ApiResponse<AttendanceRecordDto>> KioskCheckInAsync(KioskPinCheckInDto request)
    {
        ...
        // Tìm ca trực của nhân viên tại chi nhánh hôm nay
        ...
        // Kiểm tra đi muộn (> 15 phút so với StartTime)
        ...
        // Nếu là thu ngân và có nhập tiền lẻ đầu ca (Opening Float Cash), tạo phiên giao ca
