        ...
        if (!context.ShiftTemplates.Any())
        {
            var templates = new List<ShiftTemplate>
            {
                new ShiftTemplate
                {
                    ...
                    ShiftType = Domain.Enums.ShiftType.Morning,
                    Description = "Ca sáng tiêu chuẩn hệ thống từ 06:00 đến 14:00 (nghỉ 30 phút)",
                ...
                new ShiftTemplate
                {
                    ...
                    ShiftType = Domain.Enums.ShiftType.Afternoon,
                    Description = "Ca chiều tiêu chuẩn hệ thống từ 14:00 đến 22:00 (nghỉ 30 phút)",
                ...
                new ShiftTemplate
                {
                    ...
                    Description = "Ca đêm xuyên đêm tiêu chuẩn hệ thống từ 22:00 đến 06:00 hôm sau (nghỉ 45 phút)",
